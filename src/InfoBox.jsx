...
export default function InfoBox({info}){
    const INIT_IMG = "https://images.unsplash.com/photo-1581608198007-4801faa3859a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzJ8fHdlYXRoZXJ8ZW58MHx8MHx8fDA%3D"
   
    const HOT_URL = "https://images.unsplash.com/photo-1602194789455-8d0fb5673dfa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fEhvdCUyMHdlYXRoZXJ8ZW58MHx8MHx8fDA%3D";
